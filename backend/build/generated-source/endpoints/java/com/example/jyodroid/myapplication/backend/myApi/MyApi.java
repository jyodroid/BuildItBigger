 ...
 * on 2016-04-05 at 04:44:22 UTC 
 * Modify at your own risk.
 */

package com.example.jyodroid.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public GetJoke getJoke(java.lang.Integer jokeID) throws java.io.IOException {
    GetJoke result = new GetJoke(jokeID);
    initialize(result);
    return result;
  }

  public class GetJoke extends MyApiRequest<com.example.jyodroid.myapplication.backend.myApi.model.MyBean> {
     ...
     * @since 1.13
     */
    protected GetJoke(java.lang.Integer jokeID) {
      super(MyApi.this, "GET", REST_PATH, null, com.example.jyodroid.myapplication.backend.myApi.model.MyBean.class);
    ...
    private java.lang.Integer jokeID;

    /**

     */
    public java.lang.Integer getJokeID() {
      return jokeID;
    }

    public GetJoke setJokeID(java.lang.Integer jokeID) {
      this.jokeID = jokeID;
      return this;
    }
  ...
  public class SayHi extends MyApiRequest<com.example.jyodroid.myapplication.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.jyodroid.myapplication.backend.myApi.model.MyBean.class);
